...
#define KEYBOARD_STATUS_RECV_READY   0x01
#define KEYBOARD_STATUS_SEND_FULL    0x02
...
typedef struct _keyboard_state_t {
	...
	int left_shift_press : 1;       // 左shift按下
	int right_shift_press : 1;       // 右shift按下
	int right_alt_press : 1;          // alt按下
	int left_alt_press : 1;          // alt按下
	int left_ctrl_press : 1;         // ctrl键按下
	int right_ctrl_press : 1;         // ctrl键按下
} keyboard_state_t;
